...
public void getConnect() {
	   String URL="jdbc:mysql://localhost:3306/mvc05db?characterEncoding=UTF-8&serverTimezone=UTC&useSSL=false";
	   String user="root";
...
public int uploadProfile(String oFileName , String sFileName ) {

	  String SQL="insert into member(oFileName,sFileName) values(?,?)"; 
	  getConnect();
