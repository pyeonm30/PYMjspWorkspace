...
<body>
   <header class="container banner">
	<div class="row">
		     <div class="col-md-auto"><img src="img/rent_logo.jpg" alt="logoImg" id="logo" onclick="location.href='${ctx}/main.do'"></div>    
			<div class="col banner" >
				...
				<c:if test="${id eq null}">
					<button  class="btn btn-primary px-3 mx-3 " onclick="location.href='${ctx}/main.do?center=user/login'"> 로그인 </button>
					<button class="btn btn-primary px-3 mx-3"onclick="location.href='${ctx}/main.do?center=user/join'"> 회원가입 </button> 
				</c:if>
			</div>
